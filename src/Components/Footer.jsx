...
const Footer = () => {
  return (
    <div className='bg-[#FFE0BF] pb-[2rem]'>
       ...
       <img src={logo} />
        <div className='lg:flex items-center justify-between gap-[10rem] xs:mt-[2rem]'>
            <div>
            ...
            <div className='flex items-center gap-[5rem] xs:mt-[3rem]'>
                <div>
        ...
        <hr className='bg-[#E57704] h-[3px] w-full mt-[3rem]' />
            <div className='mt-[1.5rem] lg:px-[60px] xs:px-[10px] lg:flex items-center gap-[41rem]'>
                ...
                <div className='flex items-center lg:gap-[1rem] xs:gap-[2rem] xs:mt-[2rem]'>
                    <FaEnvelope className='text-[#E57704] xs:text-[20px]' />
                    <FaFacebook className='text-[#E57704] xs:text-[20px]' />
                    <FaTwitter className='text-[#E57704] xs:text-[20px]' />
                    <FaInstagram className='text-[#E57704] xs:text-[20px]' />
                    <FaLinkedinIn className='text-[#E57704] xs:text-[20px]' />
                </div>
            </div>
    </div>
  )
